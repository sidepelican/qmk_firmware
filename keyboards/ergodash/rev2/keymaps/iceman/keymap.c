...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_UP  ,                        KC_SPC , KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, RAISE,   \
    KC_ESC,  KC_LALT, KC_LALT, KC_LGUI,          LOWER,   KC_SPC ,KC_DOWN,        KC_BSPC,KC_ENT , KC_RSFT,          KANA,    KC_RGUI, KC_LBRC, KC_RBRC  \
  ),
