...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_MINS,                        KC_BSLS, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC, \
    ...
    KC_ESC,  KC_LALT, KC_LALT, KC_LGUI,          LOWER,   KC_SPC ,KC_DOWN,        KC_BSPC,KC_ENT , RAISE,            KANA,    KC_RGUI, KC_LBRC, KC_RBRC  \
  ),
