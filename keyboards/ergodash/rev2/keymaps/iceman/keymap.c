...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT(
    ...
    _______, _______, _______, _______,          LOWER,   _______,_______,        _______,_______, RAISE,           _______, _______, KC_LEFT, KC_RGHT  \
  ),
  ...
  [_RAISE] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______, _______,                        _______, _______, KC_DOWN, XXXXXXX, _______, _______, _______, \
